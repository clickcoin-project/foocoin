...
uint256 hashGenesisBlock("0x0af3f0f571143557c2dede640283caf73e40e52a9b91b9d1721f66b7d89eca02");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 50); // Nyancoin: 500k blocks
...
static const int64 nTargetSpacing = 30; // FooCoin: 2 minute blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1395818365; //epochtime
